...
const KEY_PLAIN = "4ld5fnINw5ZeNUEjOZNhRXp-PZTxS4je"; // Testfirma Eins (ohne Freigabe-Modus)
const KEY_APPROVAL = "cJaCXkVjls9umce3x9Pvg-KA3Q29eBWU"; // Testfirma Zwei (Freigabe-Modus)
