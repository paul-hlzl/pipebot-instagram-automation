...
export const IMAGE_STYLE_PREFIX =
  "minimalist Instagram graphic, dark navy-black background (near #0a0e1a) with a subtle fine linen texture, barely visible. Professional, clean, AI-generated aesthetic. Elegant white classic serif typography as the dominant visual element — a traditional serif typeface only, NOT sans-serif, NOT bold, NOT script, NOT a decorative or stylized font. All words in the headline must use the EXACT SAME font weight, style, and case throughout — no mixing of bold/regular, uppercase/lowercase, or italic/upright within a single headline; every word must look visually identical in style to every other word. Social media post format, square. Absolutely no icons, no illustrations, no photographic elements, no neural network or circuit graphics, no robotic elements, no geometric shapes, no triangles, no abstract decorative graphics, no borders, no frames, no additional graphic elements of any kind — nothing in the image except the plain textured background and the headline text. Absolutely no additional text, numbers, words, or characters anywhere in the image beyond the exact headline provided — no random text fragments, no watermark-like text, no background text of any kind. Do not add any punctuation marks (periods, exclamation points, commas) that are not explicitly part of the provided headline text. The headline text must be rendered exactly as written, letter for letter, with no missing, extra, or altered characters, and no additional characters of any kind";
